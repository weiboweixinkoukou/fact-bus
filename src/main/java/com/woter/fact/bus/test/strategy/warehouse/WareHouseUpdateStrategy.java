...
@Component
public class WareHouseUpdateStrategy implements CallKingDeeStrategy, InitializingBean {
    private Logger log = LoggerFactory.getLogger(WareHouseUpdateStrategy.class);
    ...
    public void afterPropertiesSet()  {
        KingDeeStrategyContext.STRATEGY_MAP.put(TrcOperateObject.WAREHOUSE.getName()+TrcOperateType.UPDATE.getName(),this);
    }
}
